...
public class PontuadorClassico implements Pontuador {
    ...
    public Map<Jogador, Integer> calcularPontuacaoRodada(Jogador jogador1, Jogador jogador2) {
        ...
        if (pontuacaoMaoJogador1 == pontuacaoMaoJogador2 && pontuacaoMaoJogador1 != 21 && pontuacaoMaoJogador2 != 21) {
            pontuacaoRodadaJogador1 = 10;
            pontuacaoRodadaJogador2 = 10;
        } else if (pontuacaoMaoJogador1 == 21 && pontuacaoMaoJogador2 == 21) {
        ...
        } else if (pontuacaoMaoJogador2 > 21 && pontuacaoMaoJogador1 < 21) {
            pontuacaoRodadaJogador1 = pontuacaoMaoJogador1;
            pontuacaoRodadaJogador2 = -5;
        } else if (pontuacaoMaoJogador1 > 21 && pontuacaoMaoJogador2 > 21) {
            pontuacaoRodadaJogador1 = -(pontuacaoMaoJogador1 - 21);
            pontuacaoRodadaJogador2 = -(pontuacaoMaoJogador2 - 21);
        } else if (pontuacaoMaoJogador1 == 21) {
            pontuacaoRodadaJogador1 = 30;
        } else if (pontuacaoRodadaJogador2 == 21) {
